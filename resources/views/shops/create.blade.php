...
@section("content")
    <div class="container">
        ...
        <div class="row main-form">
            ...
            <form class="" method="post" action="{{@route("shop.create")}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="cols-sm-10">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="name_shop" id="name_shop" value="{{ @old('name_shop') }}" placeholder="Введиье название магазина"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="cols-sm-10">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
                            <input type="text" class="form-control" name="phone" id="phone" value="{{ @old('phone') }}" placeholder="Введите ваш номер телефона"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="cols-sm-10">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="site" id="site" placeholder="Введите адрес сайта"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="cols-sm-10">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
                            <input type="text" class="form-control" name="work_time" id="work_time" placeholder="Время работы магазина"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="cols-sm-10">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
                            <input type="text" class="form-control" name="min_price" id="min_price" placeholder="Введите цену"/>
                        </div>
                    </div>
                </div>
